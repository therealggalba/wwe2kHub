...
const About = () => {
  return (
    <section style={{ maxWidth: '800px', margin: '0 auto' }}>
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem', borderBottom: '4px solid #e00012' }}>
        <h1 style={{ 
          fontSize: '2.5rem', 
          fontWeight: '900', 
          margin: 0,
      ...
      <div style={{ lineHeight: '1.8', color: '#ccc', fontSize: '1.1rem' }}>
        ...
        <div style={{ backgroundColor: '#111', padding: '2rem', borderRadius: '12px', border: '1px solid #333' }}>
          <h2 style={{ color: '#fff', marginBottom: '1rem' }}>Herramientas de Base de Datos</h2>
          <p style={{ marginBottom: '1rem' }}>
            Utiliza estas herramientas para gestionar tu configuración personalizada. Exporta tus datos para tener una copia de seguridad o importa archivos externos para actualizar tus stats y títulos.
          </p>
        </div>
        <div style={{ backgroundColor: '#111', padding: '2rem', borderRadius: '12px', border: '1px solid #333', marginTop: '1.5rem' }}>
